...
import { NewCategoryTable } from "@/components/tables/categories/newCategoryTable";
...
export function CreateNewCategoryModal() {
  ...
  function submitCircleRegistration(value: any) {
    console.log({ ...value, isAvailable, selectedItems });
  ...
  return (
    <ModalLayout
      ...
      className="min-w-fit h-[600px] overflow-y-auto"
    >
      <DialogHeader>
        <DialogTitle>Criar categoria</DialogTitle>
        <DialogDescription>
          Uma nova categorias para adicionar mais pratos deliciosos.
        </DialogDescription>
      </DialogHeader>
      <form
      ...
      >
        ...
        />
        <div className="min-w-[882px] p-4 overflow-y-auto">
          <NewCategoryTable data={orders} setSelectedItems={setSelectedItems} />
        </div>
        <DialogFooter>
          <DialogClose asChild>
